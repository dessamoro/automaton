...
export const STATIC_MODEL_BASELINE: Omit<ModelEntry, "lastSeen" | "createdAt" | "updatedAt">[] = [
  ...
  },
  {
    ...
    provider: "openai",
    displayName: "GLM 5.2 (OpenRouter Free)",
    tierMinimum: "normal",
    costPer1kInput: 0,
    costPer1kOutput: 0,
    maxTokens: 4096,
  ...
  },
  {
    ...
    provider: "openai",
    displayName: "Nex N2.5 Pro (OpenRouter Free)",
    tierMinimum: "normal",
    costPer1kInput: 0,
    costPer1kOutput: 0,
    maxTokens: 4096,
  ...
  },
  {
    ...
    provider: "openai",
    displayName: "Nex N2.5 Mini (OpenRouter Free)",
    tierMinimum: "critical",
    costPer1kInput: 0,
    costPer1kOutput: 0,
    maxTokens: 4096,
  ...
  },
  {
    ...
    provider: "openai",
    displayName: "Nemotron 3 Super 120B (OpenRouter Free)",
    tierMinimum: "normal",
    costPer1kInput: 0,
    costPer1kOutput: 0,
    maxTokens: 4096,
